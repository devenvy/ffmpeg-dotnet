...
VULKAN_FLAGS=()
HWACCEL_FEATURES="CUDA NVENC NVDEC VAAPI VDPAU libdrm QSV V4L2-M2M"
...
Configure flags:
--enable-ffmpeg --enable-ffprobe --disable-ffplay --enable-shared --disable-static --disable-doc --disable-debug --enable-pic --disable-gpl --disable-nonfree --disable-autodetect --enable-cuda --enable-cuvid --enable-nvenc --enable-nvdec --enable-ffnvcodec --enable-vaapi --enable-vdpau --enable-libdrm --enable-libvpl --enable-v4l2-m2m ${VULKAN_FLAGS[*]}
EOF
